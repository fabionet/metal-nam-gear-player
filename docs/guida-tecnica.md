...
**Cosa appartiene allo slot e cosa al pedale.** Allo slot appartengono la posizione nella catena, il parametro di bypass e il selettore Front / Post-Gate / Post-IR: sono proprieta' del posto, non di chi lo occupa, e infatti una sezione spenta resta spenta quando le si cambia pedale. Al pedale appartengono il titolo dipinto e il nome sul tasto (`pedalSectionTitle()`, la categoria in maiuscolo), i comandi, e i due accessori che lo seguono di sezione in sezione: l'analizzatore di spettro dell'equalizzatore e il misuratore di riduzione del compressore. Di questi ce n'e' **uno per slot**, e si mostra quello dello slot che ospita il pedale giusto; il timer di ognuno parte in `visibilityChanged()`, cosi' i nascosti non costano nulla.

...
- **Three amp sims** — GEAR SX, MARCHELLOW (JCM800 2203) and **MAUSE RECTIFIER**, a two-channel American high-gain head with per-channel Gain / Treble / Mid / Bass / Presence / Master, three modes per channel (Clean / Vintage / Modern), a tube-or-silicon rectifier and a Bold/Spongy variac. Both the power-supply sag and the per-channel presence placement are modelled, because both are audible: 1.8 dB of sag on Spongy against none on silicon, and the same presence knob giving +8.4 dB on channel 1 (feedback loop) against +1.1 dB on channel 2 (preamp).

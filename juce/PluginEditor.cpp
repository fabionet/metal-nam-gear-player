    ...
    struct InfoContent : public juce::Component {
        ...
        InfoContent() {
            ...
            credits.setText (
                ...
                "- Metal Mania (c) 2012 Open Window (Dathan Boardman)\n"
                "- Nosifer (c) 2011 Typomondo\n"
                "- Pirata One (c) 2012 Rodrigo Fuenzalida, Nicolas Massi\n"
                "See LICENSE-fonts.txt for the full OFL 1.1 text.\n\n"
                "Trademarks:\n"
